...
// import { FormControlLabel, Checkbox, Button, Grid, Typography, TextField } from '@mui/material';

// const MyPostWidget = () => {
//   const initialValues = {
//     floor: '', // Initialize the specific field you want to manage
//   };
...
//     setFieldValue('feeding', value); // Ensure only 'floor' field is updated
...
//     floor: Yup.string().required('Please select a floor space option'), // Add validation as needed
//   });
...
//       onSubmit={onSubmit}
//     >
//       {({ values, setFieldValue, isSubmitting, ErrorMessage }) => (
//         <Form>
...
//                   fullWidth
//                   variant="outlined"
//                   helperText={<ErrorMessage name="address_farm" />}
//                 />
//               </Grid>
//               <Grid item xs={4}>
//                 <Field
...
//                       name="height"
//                       value={option.value}
//                       checked={values.height === option.value}
//                       onChange={() => handleCheckboxChange1(option.value, setFieldValue)}
//                     />
//                   }
//                   label={option.label}
//                 />
...
//                       name="feeding"
//                       value={option.value}
//                       checked={values.feeding === option.value}
//                       onChange={() => handleCheckboxChange4(option.value, setFieldValue)}
//                     />
//                   }
//                   label={option.label}
//                 />
...
//                       name="human"
//                       value={option.value}
//                       checked={values.human === option.value}
//                       onChange={() => {setFieldValue('human',option.value);}}
//                     />
//                   }
//                   label={option.label}
//                 />
...
//                       name="suffering"
//                       value={option.value}
//                       checked={values.suffering === option.value}
//                       onChange={() => {setFieldValue('suffering',option.value);}}
//                     />
//                   }
//                   label={option.label}
//                 />
